...
func SendAnts(ants types.Ants, data []string, bestCombination types.Paths) []string {
	inputData(data)
...
func assignAnts(ants types.Ants, bestCombination types.Paths) [][]string {
...
func calculateSteps(queue [][]string, bestCombination types.Paths) []string {
