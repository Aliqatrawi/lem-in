...
func BestCombPaths(ants types.Ants, pathGroups types.Paths) types.Paths {
	...
	return types.Paths{BestComb: bestCombination}
}

func SortCombPaths(combinations types.Paths) types.Paths {
	...
	return types.Paths{SortComb: pathGroups}
}
